                                ...
                                <form action="${pageContext.request.contextPath}/students" method="post"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="studentId" name="studentId"
                                                value="${student.studentId}" readonly class="readonly">
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="yearOfStudy" name="yearOfStudy">
                                                ...
                                                <option value="1" ${student.yearOfStudy==1 ? 'selected' : '' }>1st Year
                                                </option>
                                                <option value="2" ${student.yearOfStudy==2 ? 'selected' : '' }>2nd Year
                                                </option>
                                                <option value="3" ${student.yearOfStudy==3 ? 'selected' : '' }>3rd Year
                                                </option>
                                                <option value="4" ${student.yearOfStudy==4 ? 'selected' : '' }>4th Year
                                                </option>
                                                <option value="5" ${student.yearOfStudy==5 ? 'selected' : '' }>5th Year
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="gpa" name="gpa" step="0.01" min="0" max="4"
                                            value="${student.gpa}" placeholder="Enter GPA (0.00 - 4.00)">
                                    </div>
